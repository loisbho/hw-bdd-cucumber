...
Scenario: restrict to movies with 'PG' or 'R' ratings
  ...
  # Then the "ratings[R]" checkbox should be checked
  # enter step(s) to uncheck all other checkboxes
  When I uncheck the following ratings: G, PG-13, NC-17
  # Then the "ratings[G]" checkbox should not be checked
  # Then the "ratings[PG-13]" checkbox should not be checked
  # Then the "ratings[NC-17]" checkbox should not be checked
